...
<section
  ...
  style="background: url('/images/aerialplatform.jpg') center / cover no-repeat;"
>
  ...
  <div class="hero-content">
    ...
    <h1>Reach Higher, Work Safer</h1>

    <p class="hero-subtext">
      LiuGong’s line of aerial work platforms not only ensures safety, our easy to operate, quick to master platforms are designed with the user in mind. Our lightweight and stable design allows for work to be done safely on all types of terrain giving you the versatility you need to get the job done.
    </p>
      ...
      <?php if (!empty($products)) : ?>
        <?php foreach ($products as $row) : ?>
          ...
          <div class="product-card">
            ...
            <!-- LINK -->
            <a href="/detailprodukaerialplatform.webp?slug=<?= htmlspecialchars($row['slug']); ?>" 
               class="product-link">
