...
<head>
    ...
    <title>Bulldozer LiuGong | Alat Berat untuk Konstruksi & Pertambangan | PT Ganda Elang Tangguh</title>
    
    <meta name="description" content="PT Ganda Elang Tangguh jual Bulldozer LiuGong berkualitas tinggi untuk konstruksi, pertambangan, perkebunan, dan infrastruktur. Tersedia berbagai tipe dengan tenaga mesin hingga 550 HP dan kapasitas blade hingga 10m³. Dealer resmi di Indonesia.">
    
    <meta name="keywords" content="Bulldozer LiuGong, alat berat bulldozer, harga bulldozer LiuGong, bulldozer untuk tambang, bulldozer perkebunan, land clearing bulldozer, dozer LiuGong, dealer bulldozer Indonesia, sparepart bulldozer LiuGong, PT Ganda Elang Tangguh">
    ...
    <!-- Open Graph / Facebook -->
    <meta property="og:title" content="Bulldozer LiuGong | Alat Berat Tangguh untuk Konstruksi & Pertambangan | PT Ganda Elang Tangguh">
    <meta property="og:description" content="PT Ganda Elang Tangguh menyediakan Bulldozer LiuGong terbaik untuk land clearing, penggusuran tanah, overburden tambang, dan konstruksi infrastruktur di Indonesia. Performa tangguh, efisien, dan tahan lama.">
    <meta property="og:image" content="https://gandaelang.co.id/images/bulldozer-liugong.jpg">
    <meta property="og:image:width" content="1200">
    <meta property="og:image:height" content="630">
    <meta property="og:image:alt" content="Bulldozer LiuGong untuk land clearing dan pertambangan">
    ...
    <meta name="twitter:image" content="https://gandaelang.co.id/images/bulldozer-liugong.jpg">
    <meta name="twitter:image:alt" content="Bulldozer LiuGong untuk proyek berat">
    
    <!-- Schema Product - Bulldozer LiuGong -->
    <script type="application/ld+json">
    {
        "@context": "https://schema.org",
        "@type": "Product",
        "name": "Bulldozer LiuGong",
        "image": "https://www.gandaelang.co.id/images/liugong-bulldozer.jpg",
        ...
        "offers": {
            ...
            "url": "https://www.gandaelang.co.id/liugong-bulldozer",
            "seller": {
                "@type": "Organization",
                "name": "PT Ganda Elang Tangguh"
            }
        ...
        "review": [
            {
                ...
                "reviewBody": "Bulldozer LiuGong LD25D sangat tangguh di medan tambang batu bara, irit solar, undercarriage awet, dan sparepart mudah didapat dari PT Ganda Elang Tangguh."
            }
        ],
        "audience": {
            "@type": "Audience",
        ...
        "keywords": "Bulldozer LiuGong, alat berat bulldozer, harga bulldozer LiuGong, sparepart bulldozer LiuGong, dealer resmi LiuGong Indonesia",
        "url": "https://www.gandaelang.co.id/liugong-bulldozer",
        "sameAs": [
    ...
    <script type="application/ld+json">
    {
        ...
        "description": "Dealer resmi alat berat LiuGong di Indonesia, menyediakan Bulldozer, Excavator, Wheel Loader, dan alat berat lainnya untuk konstruksi, pertambangan, perkebunan, dan infrastruktur.",
        "address": {
            "@type": "PostalAddress",
            "addressCountry": "ID",
    ...
    <!-- Schema FAQPage - Bulldozer LiuGong (Sudah Sesuai) -->
    <script type="application/ld+json">
    {
        "@context": "https://schema.org",
        "@type": "FAQPage",
        "mainEntity": [
            {
                "@type": "Question",
                "name": "Apa keunggulan Bulldozer LiuGong?",
                "acceptedAnswer": {
                    "@type": "Answer",
            ...
            {
                "@type": "Question",
                "name": "Apakah PT Ganda Elang Tangguh dealer resmi Bulldozer LiuGong?",
                "acceptedAnswer": {
                    "@type": "Answer",
            ...
            {
                "@type": "Question",
                "name": "Bulldozer LiuGong cocok untuk proyek apa saja?",
                "acceptedAnswer": {
                    "@type": "Answer",
            ...
            {
                "@type": "Question",
                "name": "Apakah ada layanan after-sales untuk Bulldozer LiuGong?",
                "acceptedAnswer": {
                    "@type": "Answer",
...
<section class="hero hero-image" style="background: url('/images/bulldozer.jpg') center / cover no-repeat;">
    ...
    <div class="hero-content">
        <div class="hero-breadcrumb">
            ...
            <span>></span>
            <span class="current">Bulldozers</span>
        </div>
        <h1>Power That Shapes the Ground</h1>

        <p class="hero-subtext">
          Robust bulldozers built for pushing, leveling, and site preparation with outstanding traction and durability.
        </p>
    </div>
</section>
                        ...
                        <a href="/detailprodukbulldozer.php?slug=<?= htmlspecialchars($row['slug']); ?>" class="product-link">
                            <div class="product-image">
                                <img 
                                    ...
                                    alt="<?= htmlspecialchars($row['nama_produk']); ?> - Bulldozer LiuGong"
                                    loading="lazy"
                                >
                            </div>
...
<!-- ================= FAQ SECTION - BULLDOZER LIUGONG ================= -->
<section class="faq-section">
    <div class="faq-header">
        <h2>Pertanyaan Umum</h2>
        <p>Temukan jawaban atas pertanyaan yang sering diajukan tentang Bulldozer LiuGong</p>
    </div>
    
    <div class="faq-grid">
        <div class="faq-item">
            <div class="faq-question">
                Apa keunggulan Bulldozer LiuGong dibanding merek lain?
                <i class="fas fa-chevron-down"></i>
            </div>
            <div class="faq-answer">
                <p>Bulldozer LiuGong unggul dalam tenaga tarik (drawbar pull) yang besar untuk pekerjaan dorong dan gusur tanah berat, sistem hidraulik responsif untuk kontrol blade presisi, undercarriage berkualitas tinggi dengan ketahanan aus luar biasa, kabin ergonomis dengan visibilitas optimal, serta biaya perawatan dan suku cadang yang kompetitif.</p>
            </div>
        </div>
        
        <div class="faq-item">
            <div class="faq-question">
                Berapa kapasitas blade dan berat operasi Bulldozer LiuGong?
                <i class="fas fa-chevron-down"></i>
            </div>
            <div class="faq-answer">
                <p>Bulldozer LiuGong tersedia dalam berbagai kelas mulai dari 10 ton hingga 70+ ton. Kapasitas blade (pisau dorong) mulai dari 1,8m³ hingga 10m³+ untuk model besar, dengan tenaga mesin dari 120 HP hingga 550+ HP. Berat operasi berkisar antara 10.000 kg hingga 70.000 kg sesuai seri dan konfigurasi.</p>
            </div>
        </div>
        
        <div class="faq-item">
            <div class="faq-question">
                Apakah PT Ganda Elang Tangguh dealer resmi Bulldozer LiuGong?
                <i class="fas fa-chevron-down"></i>
            </div>
            <div class="faq-answer">
                <p>Ya, PT Ganda Elang Tangguh adalah dealer resmi alat berat LiuGong di Indonesia, termasuk unit bulldozer baru, perawatan rutin (termasuk undercarriage), servis berkala, dan penyediaan sparepart original dengan garansi pabrik.</p>
            </div>
        </div>
        
        <div class="faq-item">
            <div class="faq-question">
                Bulldozer LiuGong cocok untuk proyek apa saja?
                <i class="fas fa-chevron-down"></i>
            </div>
            <div class="faq-answer">
                <p>Sangat cocok untuk pekerjaan land clearing (pembukaan lahan), penggusuran tanah dan batuan, pembuatan terasering di perkebunan (sawit, karet), konstruksi jalan dan tanggul, reklamasi lahan, pertambangan (overburden removal), serta proyek irigasi dan bendungan.</p>
            </div>
        </div>
        
        <div class="faq-item">
            <div class="faq-question">
                Apa perbedaan blade straight (S-blade) dan universal (U-blade) pada Bulldozer LiuGong?
                <i class="fas fa-chevron-down"></i>
            </div>
            <div class="faq-answer">
                <p>Straight blade (S-blade) cocok untuk pekerjaan grading dan perataan tanah dengan material keras, tanpa sisi lengkung. Universal blade (U-blade) memiliki sisi lengkung untuk kapasitas dorong lebih besar, ideal untuk memindahkan material dalam jarak menengah seperti tanah lepas dan batubara. LiuGong menyediakan kedua opsi sesuai kebutuhan proyek Anda.</p>
            </div>
        </div>
        
        <div class="faq-item">
            <div class="faq-question">
                Bagaimana cara mendapatkan harga dan simulasi kredit Bulldozer LiuGong?
                <i class="fas fa-chevron-down"></i>
            </div>
            <div class="faq-answer">
                <p>Hubungi tim sales PT Ganda Elang Tangguh melalui WhatsApp, telepon, atau form kontak. Kami akan memberikan harga terbaru, spesifikasi lengkap (tenaga mesin, kapasitas blade, berat operasi), serta simulasi kredit dengan tenor fleksibel sesuai kebutuhan proyek Anda.</p>
            </div>
        </div>
        
        <div class="faq-item">
            <div class="faq-question">
                Apakah ada layanan after-sales untuk Bulldozer LiuGong?
                <i class="fas fa-chevron-down"></i>
            </div>
            <div class="faq-answer">
                <p>Kami menyediakan layanan purna jual lengkap: garansi standar pabrik, perawatan rutin undercarriage (track shoe, track link, roller), penggantian oli dan filter, servis mobile ke lokasi proyek, pelatihan operator, dan stok sparepart original (termasuk blade, track, komponen mesin) di gudang pusat & cabang.</p>
            </div>
        </div>
    </div>
