...
<title><?= $productName ?> | Wheel Loader LiuGong | PT Ganda Elang Tangguh</title>

<meta name="description" content="Spesifikasi lengkap <?= $productName ?> wheel loader LiuGong untuk pekerjaan konstruksi, pertambangan, material handling, dan proyek infrastruktur di Indonesia.">

<meta name="keywords" content="<?= $productName ?>, wheel loader liugong, alat berat wheel loader, loader liugong indonesia, dealer liugong indonesia">
...
<meta property="og:title" content="<?= $productName ?> | Wheel Loader LiuGong">
<meta property="og:description" content="Wheel loader LiuGong berkinerja tinggi untuk pekerjaan konstruksi, pertambangan, dan material handling.">
...
<meta name="twitter:description" content="Wheel loader LiuGong untuk pekerjaan konstruksi dan pertambangan.">
...
<script type="application/ld+json">
{
 ...
 "name": "<?= $productName ?>",
 "image": "<?= $productImage ?>",
 "description": "Wheel loader LiuGong untuk pekerjaan konstruksi, pertambangan, dan material handling.",
 "brand": {
   "@type": "Brand",
   "name": "LiuGong"
 },
