...
/* ================= PRODUCT (KHUSUS CATEGORY 1 = Wheel Loader) ================= */
$stmt = $pdo->prepare("
...
/* ================= RECOMMENDED (SESAMA Wheelloader) ================= */
$q = $pdo->prepare("
    SELECT *
    FROM produk
    WHERE status = 'aktif'
...
/* ================= VARIABEL SEO ================= */
$currentUrl = "https://gandaelang.co.id/detailprodukwheelloader.php?slug=" . urlencode($product['slug']);
...
$productDesc = "Wheel loader LiuGong " . $productName . " dari PT Ganda Elang Tangguh, dealer resmi LiuGong di Indonesia. Spesifikasi lengkap, fitur unggulan, dan harga wheel loader LiuGong untuk konstruksi, pertambangan, dan infrastruktur.";
?>
...
<!-- SEO Meta -->
<title><?= $productName ?> | Wheel Loader LiuGong | Dealer Resmi LiuGong Indonesia</title>

<meta name="description" content="<?= htmlspecialchars($productDesc) ?>">

<meta name="keywords" content="<?= $productName ?>, wheel loader liugong, alat berat wheel loader, loader liugong indonesia, dealer resmi liugong indonesia, dealer liugong jakarta, pt ganda elang tangguh, alat berat liugong">
...
<!-- Open Graph -->
<meta property="og:title" content="<?= $productName ?> | Wheel Loader LiuGong | Dealer Resmi LiuGong Indonesia">
...
<meta name="twitter:title" content="<?= $productName ?> | Wheel Loader LiuGong | Dealer Resmi LiuGong Indonesia">
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://gandaelang.co.id/wheelloader"
    },
    {
      "@type": "ListItem",
      "position": 4,
...
<script type="application/ld+json">
{
  ...
  "name": "<?= $productName ?> - Wheel Loader LiuGong",
  "image": "<?= $productImage ?>",
...
<section class="hero hero-image" style="background: url('<?= $heroImage ?>') center / cover no-repeat;">
  ...
  <div class="hero-content">
    ...
    <div class="hero-breadcrumb">
      ...
      <span>›</span>
      <a href="/wheelloader">Wheel Loader</a>
      <span>›</span>
      <span class="current"><?= $productName ?></span>
    </div>

    <!-- Title -->
    <h1><?= $productName ?> - Wheel Loader LiuGong</h1>
...
<nav class="pd-menu">
  <div class="pd-menu-inner">
    <div class="pd-menu-product">
      <img src="/images/uploads/produk/<?= htmlspecialchars($product['gambar']); ?>" alt="<?= $productName ?> - Wheel Loader LiuGong">
  ...
  <div class="pd-gallery">
    <div class="pd-window">
      <div class="pd-track">
        ...
        <div class="pd-slide">
          <img src="/images/uploads/produk/<?=$g['image']?>" alt="Galeri <?= $productName ?> - Wheel Loader LiuGong">
        </div>
        <?php endforeach; ?>
      </div>
    </div>
...
<section id="pd-recommended" class="pd-section pd-gray">
  <h2>Wheel Loader LiuGong Lainnya</h2>
  <div class="pd-rec">
    <?php foreach($rec as $r): ?>
    <a href="/detailprodukwheelloader.php?slug=<?= urlencode($r['slug']); ?>" class="pd-card">
      <img src="/images/uploads/produk/<?= htmlspecialchars($r['gambar']) ?>" alt="<?= htmlspecialchars($r['nama_produk']) ?> - Wheel Loader LiuGong">
