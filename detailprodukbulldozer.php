...
/* ================= PRODUCT (KHUSUS CATEGORY 3 = BULLDOZER) ================= */
$stmt = $pdo->prepare("
...
/* ================= VARIABEL SEO ================= */
$currentUrl = "https://gandaelang.co.id/detailprodukbulldozer.php?slug=" . urlencode($product['slug']);
...
$productDesc = "Bulldozer LiuGong " . $productName . " dari PT Ganda Elang Tangguh, dealer resmi LiuGong di Indonesia. Spesifikasi lengkap, fitur unggulan, dan harga bulldozer LiuGong untuk konstruksi, pertambangan, dan infrastruktur berat.";
?>
...
<!-- SEO Meta -->
<title><?= $productName ?> | Bulldozer LiuGong | Dealer Resmi LiuGong Indonesia</title>

<meta name="description" content="<?= htmlspecialchars($productDesc) ?>">

<meta name="keywords" content="<?= $productName ?>, bulldozer liugong, alat berat bulldozer, bulldozer liugong indonesia, dealer resmi liugong indonesia, dealer liugong jakarta, pt ganda elang tangguh, alat berat liugong, bulldozer konstruksi, bulldozer pertambangan">
...
<!-- Open Graph -->
<meta property="og:title" content="<?= $productName ?> | Bulldozer LiuGong | Dealer Resmi LiuGong Indonesia">
...
<meta name="twitter:title" content="<?= $productName ?> | Bulldozer LiuGong | Dealer Resmi LiuGong Indonesia">
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://gandaelang.co.id/bulldozer"
    },
    {
      "@type": "ListItem",
      "position": 4,
...
<script type="application/ld+json">
{
  ...
  "name": "<?= $productName ?> - Bulldozer LiuGong",
  "image": "<?= $productImage ?>",
...
<section class="hero hero-image" style="background: url('<?= $heroImage ?>') center / cover no-repeat;">
  ...
  <div class="hero-content">
    ...
    <!-- Title -->
    <h1><?= $productName ?> - Bulldozer LiuGong</h1>
...
<nav class="pd-menu">
  <div class="pd-menu-inner">
    <div class="pd-menu-product">
      <img src="/images/uploads/produk/<?= htmlspecialchars($product['gambar']); ?>" alt="<?= $productName ?> - Bulldozer LiuGong">
  ...
  <div class="pd-gallery">
    <div class="pd-window">
      <div class="pd-track">
        ...
        <div class="pd-slide">
          <img src="/images/uploads/produk/<?=$g['image']?>" alt="Galeri <?= $productName ?> - Bulldozer LiuGong">
        </div>
        <?php endforeach; ?>
      </div>
    </div>
...
<section id="pd-recommended" class="pd-section pd-gray">
  <h2>Bulldozer LiuGong Lainnya</h2>
  <div class="pd-rec">
    <?php foreach($rec as $r): ?>
    <a href="/detailprodukbulldozer.php?slug=<?= urlencode($r['slug']) ?>" class="pd-card">
      <img src="/images/uploads/produk/<?= htmlspecialchars($r['gambar']) ?>" alt="<?= htmlspecialchars($r['nama_produk']) ?> - Bulldozer LiuGong">
