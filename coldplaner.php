...
<section
  ...
  style="background: url('/images/coldplaner.jpg') center / cover no-repeat;"
>
  ...
  <div class="hero-content">
    ...
    <h1>Precision in Every Cut</h1>

    <p class="hero-subtext">
      High-performance cold planers designed for efficient milling and surface preparation.
    </p>
      ...
      <?php if (!empty($products)) : ?>
        <?php foreach ($products as $row) : ?>
          ...
          <div class="product-card">
            ...
            <!-- LINK -->
            <a href="/detailprodukcoldplaner.php?slug=<?= htmlspecialchars($row['slug']); ?>" 
               class="product-link">
