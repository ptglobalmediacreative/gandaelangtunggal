...
<title>Mining Truck LiuGong Indonesia | PT Ganda Elang Tangguh</title>

<meta name="description" content="Mining truck LiuGong untuk industri pertambangan dengan kapasitas angkut besar dan performa tinggi untuk operasional tambang yang efisien.">

<meta name="keywords" content="mining truck liugong, dump truck tambang, alat berat tambang, mining equipment indonesia">
...
<!-- Open Graph -->
<meta property="og:title" content="Mining Truck LiuGong Indonesia | PT Ganda Elang Tangguh">
<meta property="og:description" content="Heavy-duty mining truck untuk operasional tambang dengan kapasitas muatan besar dan performa tinggi.">
...
<meta name="twitter:title" content="Mining Truck LiuGong Indonesia">
<meta name="twitter:description" content="Mining truck untuk operasional pertambangan dengan kapasitas muatan besar.">
...
<script type="application/ld+json">
{
 ...
 "description": "Daftar mining truck untuk industri pertambangan dengan kapasitas angkut besar.",
...
<section
  ...
  style="background: url('/images/minningtruck.jpg') center / cover no-repeat;"
>
  ...
  <div class="hero-content">
    ...
    <p class="hero-subtext">
      Heavy-duty mining trucks engineered for maximum payload capacity, durability, and productivity in demanding mining operations.
    </p>
      ...
      <?php if (!empty($products)) : ?>
        <?php foreach ($products as $row) : ?>
          ...
          <div class="product-card">
            ...
            <!-- LINK -->
            <a href="/detailprodukminningtruck.php?slug=<?= htmlspecialchars($row['slug']); ?>" 
               class="product-link">
