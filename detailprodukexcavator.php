...
/* ================= VARIABEL SEO ================= */
$currentUrl = "https://gandaelang.co.id/detailprodukexcavator.php?slug=" . urlencode($product['slug']);
...
$productDesc = "Excavator LiuGong " . $productName . " dari PT Ganda Elang Tangguh, dealer resmi LiuGong di Indonesia. Spesifikasi lengkap, fitur unggulan, dan harga excavator LiuGong untuk konstruksi, pertambangan, dan infrastruktur.";
?>
...
<!-- SEO Meta -->
<title><?= $productName ?> | Excavator LiuGong | Dealer Resmi LiuGong Indonesia</title>

<meta name="description" content="<?= htmlspecialchars($productDesc) ?>">

<meta name="keywords" content="<?= $productName ?>, excavator liugong, alat berat excavator, excavator liugong indonesia, dealer resmi liugong indonesia, dealer liugong jakarta, pt ganda elang tangguh, alat berat liugong, excavator konstruksi, excavator pertambangan">
...
<!-- Open Graph -->
<meta property="og:title" content="<?= $productName ?> | Excavator LiuGong | Dealer Resmi LiuGong Indonesia">
...
<meta name="twitter:title" content="<?= $productName ?> | Excavator LiuGong | Dealer Resmi LiuGong Indonesia">
...
<script type="application/ld+json">
{
  ...
  "name": "<?= $productName ?> - Excavator LiuGong",
  "image": "<?= $productImage ?>",
...
<section class="hero hero-image" style="background: url('<?= $heroImage ?>') center / cover no-repeat;">
  ...
  <div class="hero-content">
    ...
    <div class="hero-breadcrumb">
      ...
      <span>›</span>
      <a href="/excavator.php">Excavator</a>
      <span>›</span>
      <span class="current"><?= $productName ?></span>
    </div>

    <!-- Title -->
    <h1><?= $productName ?> - Excavator LiuGong</h1>
...
<nav class="pd-menu">
  <div class="pd-menu-inner">
    <div class="pd-menu-product">
      <img src="/images/uploads/produk/<?= htmlspecialchars($product['gambar']); ?>" alt="<?= $productName ?> - Excavator LiuGong">
  ...
  <div class="pd-gallery">
    <div class="pd-window">
      <div class="pd-track">
        ...
        <div class="pd-slide">
          <img src="/images/uploads/produk/<?=$g['image']?>" alt="Galeri <?= $productName ?> - Excavator LiuGong">
        </div>
        <?php endforeach; ?>
      </div>
    </div>
...
<section id="pd-recommended" class="pd-section pd-gray">
  <h2>Excavator LiuGong Lainnya</h2>
  <div class="pd-rec">
    <?php foreach($rec as $r): ?>
    <a href="/detailprodukexcavator.php?slug=<?= urlencode($r['slug']) ?>" class="pd-card">
      <img src="/images/uploads/produk/<?= htmlspecialchars($r['gambar']) ?>" alt="<?= htmlspecialchars($r['nama_produk']) ?> - Excavator LiuGong">
