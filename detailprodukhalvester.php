...
/* ================= PRODUCT (KHUSUS CATEGORY 15 = SUGARCANE HARVESTER) ================= */
$stmt = $pdo->prepare("
...
/* ================= RECOMMENDED (SESAMA SUGARCANE HARVESTER) ================= */
$q = $pdo->prepare("
    SELECT *
    FROM produk
    WHERE status = 'aktif'
...
$productDesc = "Sugarcane Harvester LiuGong " . $productName . " dari PT Ganda Elang Tangguh, dealer resmi LiuGong di Indonesia. Spesifikasi lengkap, fitur unggulan, dan harga sugarcane harvester LiuGong untuk panen tebu dan operasional perkebunan.";
?>
...
<!-- SEO Meta -->
<title><?= $productName ?> | Sugarcane Harvester LiuGong | Dealer Resmi LiuGong Indonesia</title>

<meta name="description" content="<?= htmlspecialchars($productDesc) ?>">

<meta name="keywords" content="<?= $productName ?>, sugarcane harvester liugong, mesin panen tebu, alat berat perkebunan, sugarcane harvester liugong indonesia, dealer resmi liugong indonesia, dealer liugong jakarta, pt ganda elang tangguh, alat berat liugong, mesin pertanian tebu">
...
<!-- Open Graph -->
<meta property="og:title" content="<?= $productName ?> | Sugarcane Harvester LiuGong | Dealer Resmi LiuGong Indonesia">
...
<meta name="twitter:title" content="<?= $productName ?> | Sugarcane Harvester LiuGong | Dealer Resmi LiuGong Indonesia">
...
<script type="application/ld+json">
{
  ...
  "name": "<?= $productName ?> - Sugarcane Harvester LiuGong",
  "image": "<?= $productImage ?>",
...
<section class="hero hero-image" style="background: url('<?= $heroImage ?>') center / cover no-repeat;">
  ...
  <div class="hero-content">
    ...
    <div class="hero-breadcrumb">
      ...
      <span>›</span>
      <a href="/halvester.php">Sugarcane Harvester</a>
      <span>›</span>
      <span class="current"><?= $productName ?></span>
    </div>

    <!-- Title -->
    <h1><?= $productName ?> - Sugarcane Harvester LiuGong</h1>
...
<nav class="pd-menu">
  <div class="pd-menu-inner">
    <div class="pd-menu-product">
      <img src="/images/uploads/produk/<?= htmlspecialchars($product['gambar']); ?>" alt="<?= $productName ?> - Sugarcane Harvester LiuGong">
  ...
  <div class="pd-gallery">
    <div class="pd-window">
      <div class="pd-track">
        ...
        <div class="pd-slide">
          <img src="/images/uploads/produk/<?=$g['image']?>" alt="Galeri <?= $productName ?> - Sugarcane Harvester LiuGong">
        </div>
        <?php endforeach; ?>
      </div>
    </div>
...
<section id="pd-recommended" class="pd-section pd-gray">
  <h2>Sugarcane Harvester LiuGong Lainnya</h2>
  <div class="pd-rec">
    <?php foreach($rec as $r): ?>
    <a href="/detailprodukhalvester.php?slug=<?= urlencode($r['slug']) ?>" class="pd-card">
      <img src="/images/uploads/produk/<?= htmlspecialchars($r['gambar']) ?>" alt="<?= htmlspecialchars($r['nama_produk']) ?> - Sugarcane Harvester LiuGong">
