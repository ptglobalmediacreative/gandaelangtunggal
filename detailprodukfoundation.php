...
/* ================= PRODUCT (KHUSUS CATEGORY 17 = FOUNDATION EQUIPMENT) ================= */
$stmt = $pdo->prepare("
...
/* ================= HERO (DARI FOUNDATION EQUIPMENT) ================= */
$q = $pdo->prepare("
    SELECT image
    FROM produk_gallery
    WHERE produk_id = ?
...
/* ================= RECOMMENDED (SESAMA FOUNDATION EQUIPMENT) ================= */
$q = $pdo->prepare("
    SELECT *
    FROM produk
    WHERE status = 'aktif'
...
/* ================= VARIABEL SEO ================= */
$currentUrl = "https://gandaelang.co.id/detailprodukfoundation.php?slug=" . urlencode($product['slug']);
...
$productDesc = "Foundation Equipment LiuGong " . $productName . " dari PT Ganda Elang Tangguh, dealer resmi LiuGong di Indonesia. Spesifikasi lengkap, fitur unggulan, dan harga foundation equipment LiuGong untuk pekerjaan pondasi, konstruksi berat, dan infrastruktur.";
?>
...
<!-- SEO Meta -->
<title><?= $productName ?> | Foundation Equipment LiuGong | Dealer Resmi LiuGong Indonesia</title>

<meta name="description" content="<?= htmlspecialchars($productDesc) ?>">

<meta name="keywords" content="<?= $productName ?>, foundation equipment liugong, alat berat pondasi, mesin pondasi konstruksi, foundation equipment liugong indonesia, dealer resmi liugong indonesia, dealer liugong jakarta, pt ganda elang tangguh, alat berat liugong, piling rig">
...
<!-- Open Graph -->
<meta property="og:title" content="<?= $productName ?> | Foundation Equipment LiuGong | Dealer Resmi LiuGong Indonesia">
...
<meta name="twitter:title" content="<?= $productName ?> | Foundation Equipment LiuGong | Dealer Resmi LiuGong Indonesia">
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "Foundation Equipment LiuGong",
...
<script type="application/ld+json">
{
  ...
  "name": "<?= $productName ?> - Foundation Equipment LiuGong",
  "image": "<?= $productImage ?>",
...
<section class="hero hero-image" style="background: url('<?= $heroImage ?>') center / cover no-repeat;">
  ...
  <div class="hero-content">
    ...
    <div class="hero-breadcrumb">
      ...
      <span>›</span>
      <a href="/foundation.php">Foundation Equipment</a>
      <span>›</span>
      <span class="current"><?= $productName ?></span>
    </div>

    <!-- Title -->
    <h1><?= $productName ?> - Foundation Equipment LiuGong</h1>
...
<nav class="pd-menu">
  <div class="pd-menu-inner">
    <div class="pd-menu-product">
      <img src="/images/uploads/produk/<?= htmlspecialchars($product['gambar']); ?>" alt="<?= $productName ?> - Foundation Equipment LiuGong">
  ...
  <div class="pd-gallery">
    <div class="pd-window">
      <div class="pd-track">
        ...
        <div class="pd-slide">
          <img src="/images/uploads/produk/<?=$g['image']?>" alt="Galeri <?= $productName ?> - Foundation Equipment LiuGong">
        </div>
        <?php endforeach; ?>
      </div>
    </div>
...
<section id="pd-recommended" class="pd-section pd-gray">
  <h2>Foundation Equipment LiuGong Lainnya</h2>
  <div class="pd-rec">
    <?php foreach($rec as $r): ?>
    <a href="/detailprodukfoundation.php?slug=<?= urlencode($r['slug']) ?>" class="pd-card">
      <img src="/images/uploads/produk/<?= htmlspecialchars($r['gambar']) ?>" alt="<?= htmlspecialchars($r['nama_produk']) ?> - Foundation Equipment LiuGong">
