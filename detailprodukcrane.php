...
/* ================= PRODUCT (KHUSUS CATEGORY 3 = crane) ================= */
...
<title><?= $productName ?> | Crane LiuGong | PT Ganda Elang Tangguh</title>

<meta name="description" content="Spesifikasi lengkap <?= $productName ?> crane LiuGong untuk pekerjaan lifting, konstruksi, dan proyek industri berat di Indonesia.">

<meta name="keywords" content="<?= $productName ?>, crane liugong, alat berat crane, crane konstruksi, dealer liugong indonesia">
...
<meta property="og:title" content="<?= $productName ?> | Crane LiuGong">
<meta property="og:description" content="Crane LiuGong berkinerja tinggi untuk pekerjaan lifting, konstruksi, dan proyek industri.">
...
<meta name="twitter:description" content="Crane LiuGong berkinerja tinggi untuk proyek konstruksi dan industri.">
...
<script type="application/ld+json">
{
 ...
 "name": "<?= $productName ?>",
 "image": "<?= $productImage ?>",
 "description": "Crane LiuGong berkinerja tinggi untuk pekerjaan lifting dan proyek konstruksi.",
 "brand": {
   "@type": "Brand",
   "name": "LiuGong"
 },
...
<a href="/detailprodukcrane.php?slug=<?=$r['slug']?>" class="pd-card">
