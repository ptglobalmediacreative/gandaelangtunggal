...
$currentUrl = "https://gandaelang.co.id/backhoeloader";
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <script type="application/ld+json">
    {
        ...
        "offers": {
            ...
            "url": "https://gandaelang.co.id/backhoeloader",
            "seller": {
                "@type": "Organization",
                "name": "PT Ganda Elang Tangguh"
            }
...
<!-- ================= HERO SECTION ================= -->
<section class="hero hero-image" style="background: url('/images/backhoeloader.jpg') center / cover no-repeat;">
            ...
            <?php if (!empty($products)) : ?>
                <?php foreach ($products as $row) : ?>
                    <div class="product-card">
                        <a href="/detailprodukbackhoeloader.php?slug=<?= htmlspecialchars($row['slug']); ?>" class="product-link">
...
<section class="faq-section">
    ...
    <div class="faq-grid" itemscope="" itemtype="https://schema.org/FAQPage">
        ...
        <div class="faq-item" itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
            ...
            <div class="faq-answer" itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                <p itemprop="text">Anda bisa menghubungi tim sales <strong>PT Ganda Elang Tangguh</strong> melalui <a href="/contact">halaman Kontak Kami</a>, WhatsApp, telepon, atau email untuk mendapatkan <strong>informasi harga backhoe loader terbaru</strong>, spesifikasi lengkap (kapasitas bucket, kedalaman gali, tenaga mesin), serta simulasi kredit dengan tenor fleksibel.</p>
            </div>
        </div>
