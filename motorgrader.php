...
<head>
    ...
    <title>Motor Grader LiuGong | Alat Berat untuk Konstruksi & Pertambangan | PT Ganda Elang Tangguh</title>
    
    <meta name="description" content="PT Ganda Elang Tangguh jual Motor Grader LiuGong berkualitas tinggi untuk konstruksi, pertambangan, perkebunan, dan infrastruktur. Tersedia berbagai tipe dengan tenaga mesin hingga 550 HP dan kapasitas blade hingga 10m³. Dealer resmi di Indonesia.">
    
    <meta name="keywords" content="Motor Grader LiuGong, alat berat Motor Grader, harga Motor Grader LiuGong, Motor Grader untuk tambang, Motor Grader perkebunan, land clearing Motor Grader, dozer LiuGong, dealer Motor Grader Indonesia, sparepart Motor Grader LiuGong, PT Ganda Elang Tangguh">
    ...
    <!-- Open Graph / Facebook -->
    <meta property="og:title" content="Motor Grader LiuGong | Alat Berat Tangguh untuk Konstruksi & Pertambangan | PT Ganda Elang Tangguh">
    <meta property="og:description" content="PT Ganda Elang Tangguh menyediakan Motor Grader LiuGong terbaik untuk land clearing, penggusuran tanah, overburden tambang, dan konstruksi infrastruktur di Indonesia. Performa tangguh, efisien, dan tahan lama.">
    <meta property="og:image" content="https://gandaelang.co.id/images/Motor Grader-liugong.jpg">
    <meta property="og:image:width" content="1200">
    <meta property="og:image:height" content="630">
    <meta property="og:image:alt" content="Motor Grader LiuGong untuk land clearing dan pertambangan">
    ...
    <meta name="twitter:description" content="Motor Grader LiuGong tangguh untuk land clearing, tambang, dan konstruksi. Tenaga besar, undercarriage kokoh, efisiensi bahan bakar optimal.">
    <meta name="twitter:image" content="https://gandaelang.co.id/images/Motor Grader-liugong.jpg">
    <meta name="twitter:image:alt" content="Motor Grader LiuGong untuk proyek berat">
    
    <!-- Schema Product - Motor Grader LiuGong -->
    <script type="application/ld+json">
    {
        ...
        "offers": {
            ...
            "url": "https://www.gandaelang.co.id/liugong-Motor Grader",
            "seller": {
                "@type": "Organization",
                "name": "PT Ganda Elang Tangguh"
            }
        ...
        "review": [
            {
                ...
                "reviewBody": "Motor Grader LiuGong LD25D sangat tangguh di medan tambang batu bara, irit solar, undercarriage awet, dan sparepart mudah didapat dari PT Ganda Elang Tangguh."
            }
        ],
        "audience": {
            "@type": "Audience",
        ...
        "keywords": "Motor Grader LiuGong, alat berat Motor Grader, harga Motor Grader LiuGong, sparepart Motor Grader LiuGong, dealer resmi LiuGong Indonesia",
        "url": "https://www.gandaelang.co.id/liugong-Motor Grader",
        "sameAs": [
    ...
    <script type="application/ld+json">
    {
        ...
        "description": "Dealer resmi alat berat LiuGong di Indonesia, menyediakan Motor Grader, Excavator, Wheel Loader, dan alat berat lainnya untuk konstruksi, pertambangan, perkebunan, dan infrastruktur.",
        "address": {
            "@type": "PostalAddress",
            "addressCountry": "ID",
    ...
    <!-- Schema FAQPage - Motor Grader LiuGong (Sudah Sesuai) -->
    <script type="application/ld+json">
    {
        "@context": "https://schema.org",
        "@type": "FAQPage",
        "mainEntity": [
            {
                "@type": "Question",
                "name": "Apa keunggulan Motor Grader LiuGong?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Motor Grader LiuGong memiliki keunggulan: tenaga tarik (drawbar pull) besar untuk pekerjaan dorong dan gusur tanah berat, sistem hidraulik responsif, undercarriage berkualitas tinggi dengan ketahanan aus luar biasa, kabin ergonomis dengan visibilitas optimal, serta biaya perawatan yang kompetitif."
                }
            },
            {
                "@type": "Question",
                "name": "Berapa kapasitas blade dan tenaga mesin Motor Grader LiuGong?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Motor Grader LiuGong tersedia dalam berbagai kelas mulai dari 10 ton hingga 70+ ton. Kapasitas blade (pisau dorong) mulai dari 1,8m³ hingga 10m³+ untuk model besar, dengan tenaga mesin dari 120 HP hingga 550+ HP, dan berat operasi berkisar antara 10.000 kg hingga 70.000 kg."
                }
            },
            {
                "@type": "Question",
                "name": "Apakah PT Ganda Elang Tangguh dealer resmi Motor Grader LiuGong?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Ya, PT Ganda Elang Tangguh adalah dealer resmi alat berat LiuGong di Indonesia yang melayani penjualan unit Motor Grader baru, perawatan rutin (termasuk undercarriage), servis berkala, pelatihan operator, dan penyediaan sparepart original dengan garansi pabrik."
                }
            },
            {
                "@type": "Question",
                "name": "Apa perbedaan blade straight (S-blade) dan universal (U-blade) pada Motor Grader LiuGong?",
                "acceptedAnswer": {
                    "@type": "Answer",
            ...
            {
                "@type": "Question",
                "name": "Apakah ada layanan after-sales untuk Motor Grader LiuGong?",
                "acceptedAnswer": {
                    "@type": "Answer",
...
<!-- ================= HERO SECTION ================= -->
<section class="hero hero-image" style="background: url('/images/motorgrader.webp') center / cover no-repeat;">
                        ...
                        <a href="/detailprodukmotorgrader.php?slug=<?= htmlspecialchars($row['slug']); ?>" class="product-link">
                            <div class="product-image">
                                <img 
                                    ...
                                    alt="<?= htmlspecialchars($row['nama_produk']); ?> - Motor Grader LiuGong"
                                    loading="lazy"
                                >
                            </div>
...
<!-- ================= FAQ SECTION - Motor Grader LIUGONG ================= -->
<section class="faq-section">
    <div class="faq-header">
        <h2>Pertanyaan Umum</h2>
        <p>Temukan jawaban atas pertanyaan yang sering diajukan tentang Motor Grader LiuGong</p>
    </div>
    
    <div class="faq-grid">
        <div class="faq-item">
            <div class="faq-question">
                Apa keunggulan utama Motor Grader LiuGong dibanding merek lain?
                <i class="fas fa-chevron-down"></i>
            </div>
            <div class="faq-answer">
                <p>Motor Grader LiuGong unggul dalam sistem hidraulik yang presisi dan responsif untuk kemiringan blade (grading) akurat, kabin ergonomis dengan visibilitas 360°, frame artikulasi yang kokoh untuk manuver tajam, serta konsumsi bahan bakar yang efisien. Didukung jaringan dealer resmi PT Ganda Elang Tangguh dengan ketersediaan suku cadang dan biaya perawatan kompetitif.</p>
            </div>
        </div>
        
        <div class="faq-item">
            <div class="faq-question">
                Berapa panjang blade dan berat operasi Motor Grader LiuGong?
                <i class="fas fa-chevron-down"></i>
            </div>
            <div class="faq-answer">
                <p>Motor Grader LiuGong tersedia dalam berbagai seri mulai dari kelas 10 ton hingga 22 ton. Panjang blade (moldboard) berkisar antara 3,7 meter hingga 4,9 meter. Tenaga mesin dari 125 HP hingga 260+ HP. Berat operasi berkisar antara 10.500 kg hingga 22.000 kg tergantung model dan konfigurasi (misal: CLG4180D, CLG4215D).</p>
            </div>
        </div>
        
        <div class="faq-item">
            <div class="faq-question">
                Apakah PT Ganda Elang Tangguh dealer resmi Motor Grader LiuGong?
                <i class="fas fa-chevron-down"></i>
            </div>
            <div class="faq-answer">
                <p>Ya, PT Ganda Elang Tangguh adalah dealer resmi alat berat LiuGong di Indonesia yang mencakup penjualan Motor Grader baru, perawatan berkala, servis, penyediaan suku cadang original, serta garansi pabrik untuk seluruh unit Motor Grader LiuGong.</p>
            </div>
        </div>
        
        <div class="faq-item">
            <div class="faq-question">
                Motor Grader LiuGong cocok untuk proyek apa saja?
                <i class="fas fa-chevron-down"></i>
            </div>
            <div class="faq-answer">
        ...
        <div class="faq-item">
            <div class="faq-question">
                Apa perbedaan sistem blade standar dan blade dengan hidraulik pintar pada Motor Grader LiuGong?
                <i class="fas fa-chevron-down"></i>
            </div>
            <div class="faq-answer">
                <p>Motor Grader LiuGong modern (seri D) dilengkapi sistem hidraulik load-sensing yang menghemat bahan bakar hingga 15% dan memberikan kontrol presisi. Untuk kebutuhan grading akurasi tinggi, LiuGong mendukung pemasangan sistem grade control (2D/3D) dari merek ternama seperti Topcon atau Leica, sehingga meningkatkan efisiensi dan mengurangi pekerjaan ulang.</p>
            </div>
        </div>
        
        <div class="faq-item">
            <div class="faq-question">
                Bagaimana cara mendapatkan harga dan simulasi kredit Motor Grader LiuGong?
                <i class="fas fa-chevron-down"></i>
            </div>
            <div class="faq-answer">
        ...
        <div class="faq-item">
            <div class="faq-question">
                Apa saja layanan after-sales untuk Motor Grader LiuGong di Indonesia?
                <i class="fas fa-chevron-down"></i>
            </div>
            <div class="faq-answer">
