...
<section class="faq-section">
    ...
    <div class="faq-grid" itemscope="" itemtype="https://schema.org/FAQPage">
        ...
        <div class="faq-item" itemscope="" itemprop="mainEntity" itemtype="https://schema.org/Question">
            ...
            <div class="faq-answer" itemscope="" itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                <p itemprop="text">Anda bisa menghubungi tim sales <strong>PT Ganda Elang Tangguh</strong> melalui <a href="/contact.php">halaman Kontak Kami</a>, WhatsApp, telepon, atau email untuk mendapatkan <strong>informasi harga paver terbaru</strong>, spesifikasi lengkap (lebar pengaspalan, hopper capacity, tenaga mesin), serta simulasi kredit dengan tenor fleksibel.</p>
            </div>
        </div>
