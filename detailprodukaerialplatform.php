...
/* ================= PRODUCT (KHUSUS CATEGORY 12 = AERIAL WORK PLATFORM) ================= */
$stmt = $pdo->prepare("
...
/* ================= HERO (DARI AERIAL WORK PLATFORM) ================= */
$q = $pdo->prepare("
    SELECT image
    FROM produk_gallery
    WHERE produk_id = ?
...
/* ================= RECOMMENDED (SESAMA AERIAL WORK PLATFORM) ================= */
$q = $pdo->prepare("
    SELECT *
    FROM produk
    WHERE status = 'aktif'
...
$productDesc = "Aerial Work Platform LiuGong " . $productName . " dari PT Ganda Elang Tangguh, dealer resmi LiuGong di Indonesia. Spesifikasi lengkap, fitur unggulan, dan harga aerial work platform LiuGong untuk pekerjaan ketinggian, konstruksi, dan industri.";
?>
...
<!-- SEO Meta -->
<title><?= $productName ?> | Aerial Work Platform LiuGong | Dealer Resmi LiuGong Indonesia</title>

<meta name="description" content="<?= htmlspecialchars($productDesc) ?>">

<meta name="keywords" content="<?= $productName ?>, aerial work platform liugong, alat berat aerial platform, aerial work platform liugong indonesia, dealer resmi liugong indonesia, dealer liugong jakarta, pt ganda elang tangguh, alat berat liugong, scissor lift, boom lift">
...
<!-- Open Graph -->
<meta property="og:title" content="<?= $productName ?> | Aerial Work Platform LiuGong | Dealer Resmi LiuGong Indonesia">
...
<meta name="twitter:title" content="<?= $productName ?> | Aerial Work Platform LiuGong | Dealer Resmi LiuGong Indonesia">
...
<script type="application/ld+json">
{
  ...
  "name": "<?= $productName ?> - Aerial Work Platform LiuGong",
  "image": "<?= $productImage ?>",
...
<section class="hero hero-image" style="background: url('<?= $heroImage ?>') center / cover no-repeat;">
  ...
  <div class="hero-content">
    ...
    <div class="hero-breadcrumb">
      ...
      <span>›</span>
      <a href="/aerialplatform.php">Aerial Work Platform</a>
      <span>›</span>
      <span class="current"><?= $productName ?></span>
    </div>

    <!-- Title -->
    <h1><?= $productName ?> - Aerial Work Platform LiuGong</h1>
...
<nav class="pd-menu">
  <div class="pd-menu-inner">
    <div class="pd-menu-product">
      <img src="/images/uploads/produk/<?= htmlspecialchars($product['gambar']); ?>" alt="<?= $productName ?> - Aerial Work Platform LiuGong">
  ...
  <div class="pd-gallery">
    <div class="pd-window">
      <div class="pd-track">
        ...
        <div class="pd-slide">
          <img src="/images/uploads/produk/<?=$g['image']?>" alt="Galeri <?= $productName ?> - Aerial Work Platform LiuGong">
        </div>
        <?php endforeach; ?>
      </div>
    </div>
...
<section id="pd-recommended" class="pd-section pd-gray">
  <h2>Aerial Work Platform LiuGong Lainnya</h2>
  <div class="pd-rec">
    <?php foreach($rec as $r): ?>
    <a href="/detailprodukaerialplatform.php?slug=<?= urlencode($r['slug']) ?>" class="pd-card">
      <img src="/images/uploads/produk/<?= htmlspecialchars($r['gambar']) ?>" alt="<?= htmlspecialchars($r['nama_produk']) ?> - Aerial Work Platform LiuGong">
