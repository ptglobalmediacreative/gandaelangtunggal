...
/* ================= PRODUCT (KHUSUS CATEGORY 18 = WAREHOUSE TRUCK) ================= */
$stmt = $pdo->prepare("
...
/* ================= RECOMMENDED (SESAMA WAREHOUSE TRUCK) ================= */
$q = $pdo->prepare("
    SELECT *
    FROM produk
    WHERE status = 'aktif'
...
/* ================= VARIABEL SEO ================= */
$currentUrl = "https://gandaelang.co.id/detailprodukwarehousetruck.php?slug=" . urlencode($product['slug']);
...
$productDesc = "Warehouse Truck LiuGong " . $productName . " dari PT Ganda Elang Tangguh, dealer resmi LiuGong di Indonesia. Spesifikasi lengkap, fitur unggulan, dan harga warehouse truck LiuGong untuk operasional gudang, logistik, dan material handling.";
?>
...
<!-- SEO Meta -->
<title><?= $productName ?> | Warehouse Truck LiuGong | Dealer Resmi LiuGong Indonesia</title>

<meta name="description" content="<?= htmlspecialchars($productDesc) ?>">

<meta name="keywords" content="<?= $productName ?>, warehouse truck liugong, material handling equipment, alat angkut gudang, warehouse truck liugong indonesia, dealer resmi liugong indonesia, dealer liugong jakarta, pt ganda elang tangguh, alat berat liugong, warehouse equipment">
...
<!-- Open Graph -->
<meta property="og:title" content="<?= $productName ?> | Warehouse Truck LiuGong | Dealer Resmi LiuGong Indonesia">
...
<meta name="twitter:title" content="<?= $productName ?> | Warehouse Truck LiuGong | Dealer Resmi LiuGong Indonesia">
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://gandaelang.co.id/warehousetruck.php"
    },
    {
      "@type": "ListItem",
      "position": 4,
...
<script type="application/ld+json">
{
  ...
  "name": "<?= $productName ?> - Warehouse Truck LiuGong",
  "image": "<?= $productImage ?>",
...
<section class="hero hero-image" style="background: url('<?= $heroImage ?>') center / cover no-repeat;">
  ...
  <div class="hero-content">
    ...
    <div class="hero-breadcrumb">
      ...
      <span>›</span>
      <a href="/warehousetruck.php">Warehouse Truck</a>
      <span>›</span>
      <span class="current"><?= $productName ?></span>
    </div>

    <!-- Title -->
    <h1><?= $productName ?> - Warehouse Truck LiuGong</h1>
...
<nav class="pd-menu">
  <div class="pd-menu-inner">
    <div class="pd-menu-product">
      <img src="/images/uploads/produk/<?= htmlspecialchars($product['gambar']); ?>" alt="<?= $productName ?> - Warehouse Truck LiuGong">
  ...
  <div class="pd-gallery">
    <div class="pd-window">
      <div class="pd-track">
        ...
        <div class="pd-slide">
          <img src="/images/uploads/produk/<?=$g['image']?>" alt="Galeri <?= $productName ?> - Warehouse Truck LiuGong">
        </div>
        <?php endforeach; ?>
      </div>
    </div>
...
<section id="pd-recommended" class="pd-section pd-gray">
  <h2>Warehouse Truck LiuGong Lainnya</h2>
  <div class="pd-rec">
    <?php foreach($rec as $r): ?>
    <a href="/detailprodukwarehousetruck.php?slug=<?= urlencode($r['slug']) ?>" class="pd-card">
      <img src="/images/uploads/produk/<?= htmlspecialchars($r['gambar']) ?>" alt="<?= htmlspecialchars($r['nama_produk']) ?> - Warehouse Truck LiuGong">
