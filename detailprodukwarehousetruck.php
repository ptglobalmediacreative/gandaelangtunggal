...
/* ================= PRODUCT (KHUSUS CATEGORY 3 = warehousetruck) ================= */
...
/* ================= RECOMMENDED (SESAMA warehousetruck) ================= */
...
<title><?= $productName ?> | Warehouse Truck LiuGong | PT Ganda Elang Tangguh</title>

<meta name="description" content="Spesifikasi lengkap <?= $productName ?> warehouse truck LiuGong untuk operasional gudang, logistik, dan material handling di Indonesia.">

<meta name="keywords" content="<?= $productName ?>, warehouse truck liugong, material handling equipment, alat angkut gudang, dealer liugong indonesia">
...
<meta property="og:title" content="<?= $productName ?> | Warehouse Truck LiuGong">
<meta property="og:description" content="Warehouse truck LiuGong berkinerja tinggi untuk operasional gudang, logistik, dan material handling.">
...
<meta name="twitter:description" content="Warehouse truck LiuGong untuk operasional gudang dan sistem logistik modern.">
...
<script type="application/ld+json">
{
 ...
 "name": "<?= $productName ?>",
 "image": "<?= $productImage ?>",
 "description": "Warehouse truck LiuGong untuk operasional gudang, logistik, dan material handling.",
 "brand": {
   "@type": "Brand",
   "name": "LiuGong"
 },
...
<a href="/detailprodukwarehousetruck.php?slug=<?=$r['slug']?>" class="pd-card">
