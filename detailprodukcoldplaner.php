...
/* ================= PRODUCT (KHUSUS CATEGORY 8 = COLD PLANER) ================= */
$stmt = $pdo->prepare("
...
/* ================= RECOMMENDED (SESAMA COLD PLANER) ================= */
$q = $pdo->prepare("
    SELECT *
    FROM produk
    WHERE status = 'aktif'
...
$productDesc = "Cold Planer LiuGong " . $productName . " dari PT Ganda Elang Tangguh, dealer resmi LiuGong di Indonesia. Spesifikasi lengkap, fitur unggulan, dan harga cold planer LiuGong untuk milling jalan, perbaikan aspal, dan proyek infrastruktur.";
?>
...
<!-- SEO Meta -->
<title><?= $productName ?> | Cold Planer LiuGong | Dealer Resmi LiuGong Indonesia</title>

<meta name="description" content="<?= htmlspecialchars($productDesc) ?>">

<meta name="keywords" content="<?= $productName ?>, cold planer liugong, mesin milling jalan, alat berat cold planer, cold planer liugong indonesia, dealer resmi liugong indonesia, dealer liugong jakarta, pt ganda elang tangguh, alat berat liugong, asphalt milling machine">
...
<!-- Open Graph -->
<meta property="og:title" content="<?= $productName ?> | Cold Planer LiuGong | Dealer Resmi LiuGong Indonesia">
...
<meta name="twitter:title" content="<?= $productName ?> | Cold Planer LiuGong | Dealer Resmi LiuGong Indonesia">
...
<script type="application/ld+json">
{
  ...
  "name": "<?= $productName ?> - Cold Planer LiuGong",
  "image": "<?= $productImage ?>",
  "description": "<?= htmlspecialchars($productDesc) ?>",
  "category": "Cold Planer",
  "brand": {
    "@type": "Brand",
    "name": "LiuGong"
  },
...
<section class="hero hero-image" style="background: url('<?= $heroImage ?>') center / cover no-repeat;">
  ...
  <div class="hero-content">
    ...
    <div class="hero-breadcrumb">
      ...
      <span>›</span>
      <a href="/coldplaner.php">Cold Planer</a>
      <span>›</span>
      <span class="current"><?= $productName ?></span>
    </div>

    <!-- Title -->
    <h1><?= $productName ?> - Cold Planer LiuGong</h1>
...
<nav class="pd-menu">
  <div class="pd-menu-inner">
    <div class="pd-menu-product">
      <img src="/images/uploads/produk/<?= htmlspecialchars($product['gambar']); ?>" alt="<?= $productName ?> - Cold Planer LiuGong">
  ...
  <div class="pd-gallery">
    <div class="pd-window">
      <div class="pd-track">
        ...
        <div class="pd-slide">
          <img src="/images/uploads/produk/<?=$g['image']?>" alt="Galeri <?= $productName ?> - Cold Planer LiuGong">
        </div>
        <?php endforeach; ?>
      </div>
    </div>
...
<section id="pd-recommended" class="pd-section pd-gray">
  <h2>Cold Planer LiuGong Lainnya</h2>
  <div class="pd-rec">
    <?php foreach($rec as $r): ?>
    <a href="/detailprodukcoldplaner.php?slug=<?= urlencode($r['slug']) ?>" class="pd-card">
      <img src="/images/uploads/produk/<?= htmlspecialchars($r['gambar']) ?>" alt="<?= htmlspecialchars($r['nama_produk']) ?> - Cold Planer LiuGong">
